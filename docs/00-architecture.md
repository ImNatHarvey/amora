...
**Phase 3b — Conversational intake — ⚠️ BUILT, AWAITING THE API KEY**
...
>
> **What is outstanding is `GEMINI_API_KEY`**, which blocks three of the four
> criteria. The unit tests prove nothing unsafe survives even a misbehaving
> model; the 20-utterance run proves the model behaves. Both were specified and
